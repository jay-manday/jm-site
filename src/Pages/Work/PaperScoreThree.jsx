...
class PaperScoreThree extends Component {
  constructor() {
    super();
    this.state = {
      visible: true
            ...
            <Flex wrap>
              ...
              <Box w={[2/4]} p={[2, 3]} pl={[2, 3]} pt={[3, 4]}>
                <ResponsiveDisplayBig>
                  <Box pb={2}>
                    <AboutType>
                      A series of studies on inter-relationship of emergent media in concurrence with traditional
                       mediums such as paper-craft through a concomitant compositional schema.
                    </AboutType>
                  </Box>
                  ...
                  <Box pb={2}>
                    <AboutType>
                      As the participant channels the instructions, the transitory motion of pencil in hand
                       across paper, producing acoustic artifacts which are projected through same paper of causation.
                    </AboutType>
                  </Box>
                </ResponsiveDisplayBig>
              </Box>
                  ...
                  <Box pb={2}>
                    <AboutType>
                      A composition made of the recordings from the physical formulation of pulp to paper is projected
                       through the paper via transducers while the piece was at rest, awaiting activation by
                        the realization of an inter-dependent score.
                    </AboutType>
                  </Box>
                  <Box pb={2}>
                    <AboutType>
                      As the participant channels the instructions, the transitory motion of pencil in hand across
                       paper, producing acoustic artifacts which are projected through same paper of causation.
                    </AboutType>
                  </Box>
                </ResponsiveDisplaySmall>
              </Box>
                  ...
                  <Box pb={2}>
                    <AboutType>
                      Milller Puckette is creator of the Max & Pure Data programming languages which he developed
                       at IRCAM in 1987. Miller Puckette has a Ph.D. in Mathematics from Harvard and was a
                       founding member of the MIT Media Lab. He teaches in the Music department at UC San Diego
                       and was the Associate Director of the Center for Research in Computing & the Arts.
                    </AboutType>
                  </Box>
                  <Box pb={2}>
                    <AboutType>
